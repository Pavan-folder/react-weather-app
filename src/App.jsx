 ...
 useEffect(() => {
  ...
  fetch(url)
    ...
    .then((data) => {
      ...
      if (condition === "Clouds") {
        setimg("https://up.yimg.com/ib/th?id=OIP.82FAs5Z8MRVehyW1Fj3y1QHaEf&pid=Api&rs=1&c=1&qlt=95&w=156&h=94");
      } else if (condition === "Clear") {
        setimg("https://wallpapercave.com/wp/wp5544455.jpg");
      } else if (condition === "Rain") {
        setimg("https://tse1.mm.bing.net/th?id=OIP.fkWr_1EeH5QcmzbfQ7GlvQHaE8&pid=Api&P=0&h=180");
      } else if (condition === "Thunderstorm") {
        setimg("https://tse3.mm.bing.net/th?id=OIP.MDm6UC0ixTnNwGvDw8YhsgHaE7&pid=Api&P=0&h=180");
      } else if (condition === "Snow") {
        setimg("https://tse1.mm.bing.net/th?id=OIP.4T-8vQVMsXZiX1I1c50EtAHaE4&pid=Api&P=0&h=180");
      } else if (condition === "Mist") {
        setimg("https://tse3.mm.bing.net/th?id=OIP.3Up8jUsps99LOeWSFpr_sQHaE8&pid=Api&P=0&h=180");
      } else {
        setimg(""); // fallback
      }
    })
